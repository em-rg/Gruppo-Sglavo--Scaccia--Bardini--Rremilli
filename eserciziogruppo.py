...
if moderate_corrs:
    for var, corr in sorted(moderate_corrs, key=lambda x: abs(x[1]), reverse=True)[:10]:
        print(f"   {var}: {corr:.3f}")
#correlazioni forti tra: G1 e G2: 0.865, G1 e G3: 0.826, G2 e G3: 0.901
#le correlazioni forti tra Medu e Fedu: 0.647, Dalc e Walc: 0.167
#G1 ha una correlazione positiva con G2 e G3 
